...
<?php wp_print_inline_script_tag(wp_json_encode($mol_editor_context, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT), ['type' => 'application/json', 'id' => 'mol-editor-data']); ?>
