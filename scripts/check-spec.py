...
expected_names = {'ElementCreate', 'ElementPatch', 'Geometry', 'ElementStyle', 'BubbleStyle', 'NarrationStyle', 'FreeTextStyle', 'SfxStyle', 'PresetCreate', 'PresetPatch', 'ReportCreate', 'ReportPatch'}
if set(contracts) != expected_names or any(contracts[name] != schemas[name] for name in expected_names):
