# Manga Overlay — تأسيس WordPress وتجارب المحرر
...
- منع حذف عمل ذي فصول عبر WordPress دون خدمة حذف مترابطة.
