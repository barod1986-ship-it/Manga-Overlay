...
المشروع في مرحلة تنفيذ الـMVP وفق **Manga Overlay Master Spec v1.1.3**. اكتملت نواة الإضافة ومخطط البيانات وإدارة المحتوى وواجهات القراءة العامة والقالب والقارئ ومحرر العناصر حتى T‑13 على مستوى التنفيذ وCI، مع تثبيت Core 0.10.1 واختبار دورة القفل وتعارض 412 على موقع التجارب.
