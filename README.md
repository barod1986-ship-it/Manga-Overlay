...
**هذه نسخة تطوير؛ الموقع الكامل لم يكتمل.** Core 0.5.0 يدير الفصول والصفحات ويشغّل المكتبة والقارئ مع القالب المرفق. أضيف هيكل المحرر T-10 المتصل بالبيانات الفعلية لعرض الطبقات والخصائص والمعاينة؛ التعديل والنشر غير متاحين فيه بعد. تجربة إدخال المحرر PoC مستقلة، وتغييراتها محلية داخل الجلسة. المستودع المعتمد هو [barod1986-ship-it/Manga-Overlay](https://github.com/barod1986-ship-it/Manga-Overlay). لم يُنشر أي شيء على خادم xCloud.
